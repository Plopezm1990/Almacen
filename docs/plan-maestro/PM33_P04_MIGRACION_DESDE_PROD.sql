-- PM33 P04 -- Migración completa desde el estado real de PROD.
--
-- Probado con Postgres real (16.13) partiendo de la función de 0
-- argumentos EXACTA hoy vigente en PROD (prod_original_function_20260919.sql),
-- igual que P03. Resultado del ensayo: preflight/apply/postflight en
-- verde, comprobación funcional de que la llamada sin argumentos (único
-- call site real) ejecuta el cuerpo nuevo tras migrar.
--
-- ===========================================================================
...
-- ===========================================================================
-- ROLLBACK -- emergencia. Restaura EXACTAMENTE el cuerpo de PROD capturado
-- el 19/09/2026 y retira la sobrecarga nueva.
-- ===========================================================================
-- begin;
