...
if old_add in s:
    ...
    # Ya puede existir una versión PM13 anterior del parche: reforzar el orden de los campos controlados por sistema.
...
# La operación históricamente llamada deleteEmpleado se conserva como API interna
# por compatibilidad, pero desde PM13 significa BAJA LÓGICA. Nunca borra ficha ni nóminas.
...
# UI Personal: la acción destructiva se presenta y ejecuta como baja lógica.
...
# Mostrar la trazabilidad de la baja en la tarjeta del empleado.
...
# Exportación individual: conservar y hacer visible el estado de baja.
...
# Barreras: no puede quedar el CTA destructivo antiguo dentro de Personal.
