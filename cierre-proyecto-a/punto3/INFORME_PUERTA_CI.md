...
SHA final validado: **`96457de25027a2e0d479ab9ba1896ad7d89832a0`** (coincide
...
5. **El SHA probado es exactamente el HEAD de la rama**: `git log -1` local
   ...
   verde final = `96457de25027a2e0d479ab9ba1896ad7d89832a0`.
...
(Más este propio informe, `cierre-proyecto-a/punto3/INFORME_PUERTA_CI.md`,
que es documentación de cierre y no forma parte de la infraestructura
general — igual que en el Punto 2, vive fuera de `tests/ci/` a propósito.)
...
## 6. Propuesta de required status check — pendiente de autorización
