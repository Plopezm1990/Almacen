-- P2 · PM11 · sustrato Personal post-reset · reconstruido sobre release actual
-- Conserva explícitamente PM13-P01 alta concurrency lock (20260907195207):
-- prefijo pm13:empleado:alta + rechazo de pseudo-locales TODOS.
